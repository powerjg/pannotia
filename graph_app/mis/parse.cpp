...
ell_array *csr2ell(csr_array *csr, int num_nodes, int num_edges, int fill)
{
    ...
    ell_array *ell = (ell_array *)malloc_global(sizeof(ell_array));
    if (!ell) printf("malloc_global failed");

    ell->max_height = maxheight;
    ell->num_nodes = num_nodes;

    ell->col_array = (int*)malloc_global(sizeof(int) * maxheight * num_nodes);
    ell->data_array = (int*)malloc_global(sizeof(int) * maxheight * num_nodes);
...
csr_array *parseMetis(char* tmpchar, int *p_num_nodes, int *p_num_edges, bool directed)
{
    ...
    char *line = (char *)malloc_global(8192);
    ...
    while (fgets(line, 8192, fptr)) {
        ...
        if (lineno == 0) { //the first line
            ...
            col_cnt = (int *)malloc_global(*p_num_nodes * sizeof(int));
            if (!col_cnt) {
            ...
            tuple_array = (CooTuple *)malloc_global(sizeof(CooTuple) * num_edges);
    ...
    int *row_array = (int *)malloc_global((num_nodes + 1) * sizeof(int));
    int *col_array = (int *)malloc_global(num_edges * sizeof(int));
    int *data_array = (int *)malloc_global(num_edges * sizeof(int));
...
double_edges *parseMetis_doubleEdge(char* tmpchar, int *p_num_nodes, int *p_num_edges, bool directed)
{
    ...
    int *edge_array1 = (int *)malloc_global(num_edges * sizeof(int));
    int *edge_array2 = (int *)malloc_global(num_edges * sizeof(int));
    ...
    double_edges *de = (double_edges *)malloc_global(sizeof(double_edges));
